...
const GAME_CONFIG = {
    ...
    LIGHTING: {
        DEFAULT_RADIUS: 15,           // Радиус освещения в тайлах
        MIN_RADIUS: 5,                // Минимальный радиус
        MAX_RADIUS: 50,               // Максимальный радиус
        FALLOFF: 1.5,                 // Экспонента затухания (чем больше, тем резче переход)
        AMBIENT_LIGHT: 0.15,          // Фоновое освещение (0-1)
